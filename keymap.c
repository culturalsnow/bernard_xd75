 ...
 */
 ...
 [_QW] = { /* QWERTY */
  { KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_QUOT, LGUI(KC_L),  KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS  },
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC, LCTL(LALT(KC_DEL)), KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS  },
  { RCTL(KC_ENT), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    _______, KC_UP,  _______, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
  { KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LEFT,  KC_DOWN,   KC_RGHT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC  },
  { KC_LGUI, KC_LALT, _______, _______, MO(_FN),  KC_BSPC,  KC_LCTL, _______, KC_ENT, KC_BSPC,  MO(_FN),  _______, _______, _______, _______  },
 },
